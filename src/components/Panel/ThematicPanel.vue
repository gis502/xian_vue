...
// 辅助函数：从cookie获取值
    ...
    handleImageError(event) {
      ...
      placeholder.style.cssText = 'height:75%;display:flex;align-items:center;justify-content:center;background:#f5f5f5;border-radius:8px;color:#999;font-size:14px;';
