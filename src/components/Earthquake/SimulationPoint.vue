...
//     });
//   });
//   basicLayers.addHiddenDangerPoints(datas, riskArea);
// });

// // 添加滑坡
// landslideHazardPointData().then((res) => {
//   basicLayers.addHiddenDangerPoints(res.data, landslideIcon);
// });

// 添加泥石流
// dataOnHiddenDangerPointsOfDebrisFlow().then((res) => {
//   basicLayers.addHiddenDangerPoints(res.data, debrisFlowIcon);
// });
